/**
 * Real Talk 6 – 대화 요약 (Favorite Movies)
 * man.png (Kevin), student.png (학생) - student 이미지는 그대로 유지
 */

import { useCallback, useState } from 'react';
import type { SummaryItem } from '../realTalk6Types';

const REALTALK6_TOPIC = 'TOPIC: Favorite Movies';
const KEVIN_AVATAR = '/man.png';
...
type RealTalk6SummaryScreenProps = {
  items: SummaryItem[];
  onNext: () => void;
};

export function RealTalk6SummaryScreen({ items, onNext }: RealTalk6SummaryScreenProps) {
  ...
  return (
    <div className="screen-content screen-content--step3-colors-no-frame" data-screen="rt6-summary">
