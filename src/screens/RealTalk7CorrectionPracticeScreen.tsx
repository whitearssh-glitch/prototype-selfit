 ...
 * TTS: realTalk7TTS (Advanced, tts-voices-by-level.json)
 */

import { useCallback, useEffect, useRef, useState } from 'react';
import { useSTT } from '../useSTT';
import { speak, stopSpeaking } from '../realTalk7TTS';
import { evaluateCorrectionPractice } from '../realTalk7Gemini';
...
type RealTalk7CorrectionPracticeScreenProps = {
  items: ErrorLogItem[];
  onComplete: () => void;
};

export function RealTalk7CorrectionPracticeScreen({ items, onComplete }: RealTalk7CorrectionPracticeScreenProps) {
        ...
        >
          <div className="screen7-stamp-circle recap-good-stamp-circle">
            <svg className="screen7-stamp-svg" viewBox="0 0 120 120" aria-hidden>
              <defs>
                <path id="recap-correction-stamp-star-rt7" d="M0 -2.1 L0.5 -0.5 L2.2 -0.5 L0.8 0.5 L1.3 2.1 L0 1.1 L-1.3 2.1 L-0.8 0.5 L-2.2 -0.5 L-0.5 -0.5 Z" fill="#fff" />
              </defs>
              <circle cx="60" cy="60" r="52" fill="none" stroke="#fff" strokeWidth={3} />
              <use href="#recap-correction-stamp-star-rt7" transform="translate(98, 38) scale(2)" />
              <use href="#recap-correction-stamp-star-rt7" transform="translate(82, 22) scale(2)" />
              <use href="#recap-correction-stamp-star-rt7" transform="translate(60, 16) scale(2)" />
              <use href="#recap-correction-stamp-star-rt7" transform="translate(38, 22) scale(2)" />
              <use href="#recap-correction-stamp-star-rt7" transform="translate(22, 38) scale(2)" />
              <use href="#recap-correction-stamp-star-rt7" transform="translate(22, 82) scale(2)" />
              <use href="#recap-correction-stamp-star-rt7" transform="translate(38, 98) scale(2)" />
              <use href="#recap-correction-stamp-star-rt7" transform="translate(60, 104) scale(2)" />
              <use href="#recap-correction-stamp-star-rt7" transform="translate(82, 98) scale(2)" />
              <use href="#recap-correction-stamp-star-rt7" transform="translate(98, 82) scale(2)" />
