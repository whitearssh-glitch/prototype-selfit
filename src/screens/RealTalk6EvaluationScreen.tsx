/**
 * Real Talk 6 – 세션 평가 (Favorite Movies)
 */

import { useEffect } from 'react';
import { evaluateSession } from '../realTalk6Gemini';
import type { ErrorLogItem, SessionEvaluation, SummaryItem } from '../realTalk6Types';
...
type RealTalk6EvaluationScreenProps = {
...
export function RealTalk6EvaluationScreen({
  evaluation,
  onEvaluationLoaded,
  conversationSummary,
  errorLog,
  onNext,
}: RealTalk6EvaluationScreenProps) {
  useEffect(() => {
    if (evaluation === null) {
  ...
  if (evaluation === null) {
    return (
      <div className="screen-content screen-content--step3-colors-no-frame" data-screen="rt6-eval">
