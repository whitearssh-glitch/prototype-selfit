/**
 * Real Talk 6 – 에러 리뷰 (Favorite Movies)
 */

import { useCallback, useMemo } from 'react';
import { diffWords, type Change } from 'diff';
import { getCorrectionPracticeItems, selectErrorsForReview } from '../realTalk6Types';
...
type RealTalk6ErrorReviewScreenProps = {
  errorLog: ErrorLogItem[];
  onNext: () => void;
};

export function RealTalk6ErrorReviewScreen({ errorLog, onNext }: RealTalk6ErrorReviewScreenProps) {
  ...
  return (
    <div className="screen-content screen-content--step3-colors-no-frame" data-screen="rt6-error-review">
