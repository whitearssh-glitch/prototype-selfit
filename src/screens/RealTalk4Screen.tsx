...
export function RealTalk4Screen({ firstPhraseDone = false, firstPhraseInProgress = false, onComplete }: RealTalk4ScreenProps) {
  ...
  const handleUserUtterance = useCallback(
    async (userText: string) => {
      ...
      if (result.correction) {
        ...
        // API/mock가 cathyPhrase를 잘못 줄 수 있으므로 항상 고정 디렉션 사용
        setPhase('correction');
