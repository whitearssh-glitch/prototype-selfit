/**
 * Real Talk 7 – 세션 평가 (Ordering Hamburgers)
 */

import { useEffect } from 'react';
import { evaluateSession } from '../realTalk7Gemini';
import type { ErrorLogItem, SessionEvaluation, SummaryItem } from '../realTalk7Types';
...
type RealTalk7EvaluationScreenProps = {
...
export function RealTalk7EvaluationScreen({
  evaluation,
  onEvaluationLoaded,
  conversationSummary,
  errorLog,
  onNext,
}: RealTalk7EvaluationScreenProps) {
  useEffect(() => {
    if (evaluation === null) {
  ...
  if (evaluation === null) {
    return (
      <div className="screen-content screen-content--step3-colors-no-frame" data-screen="rt7-eval">
