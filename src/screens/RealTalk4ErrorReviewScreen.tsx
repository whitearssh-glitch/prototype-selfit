/**
 * Real Talk 4 – 에러 리뷰 (Grocery Shopping)
 */

import { useCallback, useMemo } from 'react';
import { diffWords, type Change } from 'diff';
import { getCorrectionPracticeItems, selectErrorsForReview } from '../realTalk4Types';
...
type RealTalk4ErrorReviewScreenProps = {
  errorLog: ErrorLogItem[];
  onNext: () => void;
};

export function RealTalk4ErrorReviewScreen({ errorLog, onNext }: RealTalk4ErrorReviewScreenProps) {
  ...
  return (
    <div className="screen-content screen-content--step3-colors-no-frame" data-screen="rt4-error-review">
