/**
 * Real Talk 5 – 대화 요약 (Meet New Friends)
 * girl.png (Cathy), student.png (학생)
 */

import { useCallback, useState } from 'react';
import type { SummaryItem } from '../realTalk5Types';
...
type RealTalk5SummaryScreenProps = {
  items: SummaryItem[];
  onNext: () => void;
};

export function RealTalk5SummaryScreen({ items, onNext }: RealTalk5SummaryScreenProps) {
  ...
  return (
    <div className="screen-content screen-content--step3-colors-no-frame" data-screen="rt5-summary">
