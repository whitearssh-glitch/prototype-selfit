/**
 * Real Talk 5 – 에러 리뷰 (Meet New Friends)
 * Selena's Secret Tip 레이아웃. More Natural / Say It Better 헤드.
 */

import { useCallback, useMemo } from 'react';
import { diffWords, type Change } from 'diff';
import { getCorrectionPracticeItems, selectErrorsForReview } from '../realTalk5Types';
...
type RealTalk5ErrorReviewScreenProps = {
  errorLog: ErrorLogItem[];
  onNext: () => void;
};

export function RealTalk5ErrorReviewScreen({ errorLog, onNext }: RealTalk5ErrorReviewScreenProps) {
  ...
  return (
    <div className="screen-content screen-content--step3-colors-no-frame" data-screen="rt5-error-review">
