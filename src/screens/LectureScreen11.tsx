/**
 * Screen 11 – Type 2-1 (Speed Up section)
 * Center text: I am / 나는 ~예요
 * Audio: i-am.mp3 (tap to play)
 */
...
const CENTER_TEXT_LINE2 = '나는 ~예요, 해요';
const AUDIO_FILE = '/i-am.mp3';
...
export interface LectureScreen11Props {
  onNext: () => void;
