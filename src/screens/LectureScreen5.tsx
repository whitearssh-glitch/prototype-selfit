...
const AUDIO_FILES = ['/screen5-1.mp3', '/screen5-2.mp3', '/screen5-3.mp3'];

/**
 * Screen 5 – Type A (Lecture Intro)
 * LAYOUT FIXED: topic box, center image (ch.png), bottom text box, Next (after audio). Tap → audio (3 files) → image shake.
 * Bottom text: I am / 나는 ~예요, ~해요
 */

export function LectureScreen5({ onNext }: { onNext: () => void }) {
      ...
      <div className="screen-center">
        ...
        <div className="screen-bottom">
          <div className="text-box text-box-two-lines">
            <span className="text-box-line">I am</span>
            <span className="text-box-line">나는 ~예요, ~해요</span>
          </div>
        </div>
      </div>
    </div>
