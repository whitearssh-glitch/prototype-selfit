 ...
 * man3.png — Adv A (tts-voices-by-level.json advanced)
 */
...
export function RealTalk7Screen({ firstPhraseDone = false, firstPhraseInProgress = false, onComplete }: RealTalk7ScreenProps) {
  ...
  const handleUserAccepted = useCallback(
    ...
    [userTurnIndex, playCathyAndShowMic]
  );
